    ...
    <div class="container">
        <div class="row g-4 justify-content-center">
            ...
            try {
                ...
                $sql = "SELECT course_id, name, target_audience, min_age, max_age, description FROM course ORDER BY course_id ASC";
                ...
                if ($courses && count($courses) > 0):
                    foreach ($courses as $course):
                        ...
                        $course_image = (strpos(strtolower($course['name']), 'english') !== false)
                            ? 'image/english_course.png'
                            : 'image/chinese_course.png';
            ?>
