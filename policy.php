...
<div class="container py-5">
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Vision College Learning Centre.</p>
        </li>
        <li>
            <p><strong>Cookies</strong> are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website, among its many uses.</p>
        </li>
        <li>
            <p><strong>Country/State</strong> refers to: New Zealand.</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to Vision College Learning Centre, accessible from <a href="https://www.visioncollegelearningcentre.ac.nz" rel="external nofollow noopener" target="_blank">https://www.visioncollegelearningcentre.ac.nz</a>.</p>
        </li>
        <li>
...
<div class="container py-5 text-center">
    <a href="policy.docx" download class="btn btn-primary shadow-sm"> Download Privacy Policy</a>
</div>
